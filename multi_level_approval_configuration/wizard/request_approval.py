...
class RequestApproval(models.TransientModel):
    ...
    #    self.action_send_notification(record_name,record.pic_id)
    ...
    def action_send_notification(self, po,approval):
        ...
        self.env['mail.message'].sudo().create({
            ...
            'body':"يرجي الموافقه علي الطلب : "  + po,  # here add the message body
            ...
            'res_id': approval.id,  # here add the channel you created.
        })
    ...
    def action_request(self):
        ...
        self.action_send_notification(self.description,request.pic_id)
